  ...
  return (
    ...
    <>
      ...
      <div>
        ...
        <div className={style.HundaiFirstDivBackIMG}>

          <div className={style.hyundaiFormDiv}>

            <img src="https://www.revv.co.in/grapheneImages/newopen/logo_hyundai_sub_web@3x.png" alt="" />

            <p>Powered by Revv</p>


            <h1 className={style.hyundaiCarHTwoTag}>Hyundai Car Subscription</h1>
...
export default HyundaiSubscription